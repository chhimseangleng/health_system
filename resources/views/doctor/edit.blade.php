        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="mb-6">
                        <h2 class="text-2xl font-bold text-gray-800">Edit Doctor</h2>
                    ...
                    <form method="POST" action="{{ route('doctors.update', $doctor->_id) }}" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            ...
                            <select id="role"
                                ...
                                @foreach ($roles as $role)
                                    <option value="{{ $role->name }}" {{ old('role', $doctor->role) == $role->name ? 'selected' : '' }}>
                                        {{ ucfirst($role->name) }}
                                    </option>
                                @endforeach
                            </select>
