...
<head>
    ...
    <!-- Custom Styles for Font Support -->
    <style>
        /* Khmer Font Support */
        .khmer-font {
            font-family: 'Noto Sans Khmer', 'Kantumruy Pro', 'Khmer OS', 'Khmer Sangam MN', 'Arial Unicode MS', sans-serif;
        }
        ...
        /* Ensure proper line height for Khmer text */
        .khmer-text {
            line-height: 1.6;
        }

        /* Ensure proper line height for English text */
        .english-text {
            line-height: 1.5;
        }
    </style>
        ...
        <div class="w-64 h-screen bg-white shadow-lg fixed">
                    ...
                    <div class="relative">
                        <div class="w-10 h-10 bg-purple-100 rounded-full flex items-center justify-center">
                            <div class="w-6 h-6 bg-red-500 rounded-full flex items-center justify-center">
                                <a href="{{ route('dashboard') }}"><img src="{{ asset('IMG/samaky.png') }}"
                                        alt="icon" class="w-6 h-6 rounded-full object-cover"></a>
                            </div>
                        </div>
                    </div>
                    <div>
            ...
            <nav class="px-4 space-y-2">
                ...
                <a href="{{ route('workspace.index') }}"
                    ...
                    <span>{{ trans('lang.disease department') }}</span>
                </a>
                @endif
                ...
                <a href="{{ route('register') }}"
                    class="flex items-center px-4 py-3 {{ request()->routeIs('register') ? 'text-white bg-purple-500' : 'text-gray-700 hover:bg-gray-50' }} rounded-xl transition-colors duration-200">
                    <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="absolute bottom-0 left-0 right-0 p-4 border-t border-gray-100">
                <!-- Help -->
                <a href="{{ route('help') }}"
                    class="flex items-center px-4 py-2 text-gray-700 hover:bg-gray-50 rounded-lg transition-colors duration-200 mb-4">
                    <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button type="submit"
                        class="flex items-center w-full px-4 py-2 text-red-600 hover:bg-red-50 rounded-lg transition-colors duration-200 mb-4">
                        <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1">
                            </path>
                        </svg>
                        <span>{{ trans('lang.log out') }}</span>
                    </button>
                </form>
                    ...
                    <div class="flex justify-between h-16">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <button id="theme-toggle" onclick="toggleTheme()"
                                ...
                                <svg id="icon-moon" class="w-5 h-5" style="display:none;" fill="none"
                            ...
                            <div x-data="{ open: false }" class="relative">
                                ...
                                <div x-show="open" @click.away="open = false"
                                    ...
                                    <form action="{{ route('locale.change') }}" method="POST"
                                        onsubmit="handleLanguageChange(event)">
                                        @csrf
        ...
        function applyFont() {
            ...
            if (locale === 'kh') {
                ...
                document.body.style.fontFamily =
                    "'Noto Sans Khmer', 'Kantumruy Pro', 'Khmer OS', 'Khmer Sangam MN', 'Arial Unicode MS', sans-serif";
            } else {
