                ...
                <div class="p-6 border-2 border-gray-200 border-dashed rounded-lg">
                    ...
                    <div class="flex justify-between items-center mb-8">
                        <a href="{{ route('workspace.vaccine.index') }}">
                            <button class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-orange-500 bg-blue-600 hover:from-blue-600 hover:to-red-700 text-white font-semibold rounded-lg shadow-md hover:shadow-lg transition-all duration-200">
                    ...
                    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6 border border-blue-200 mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 text-sm">
                            ...
                            <div>
                                ...
                                <p class="text-gray-900">{{ \Carbon\Carbon::parse($patient->date_of_birth)->age }} years</p>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                @endphp
                                @if($paymentType)
                                    <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium {{ $paymentColors[$paymentType] ?? 'bg-gray-100 text-gray-800' }}">
                    ...
                    <div class="bg-white rounded-xl shadow-lg p-8 border border-gray-200">
                        ...
                        <form action="{{ route('workspace.vaccine.patient.store', $patient->_id ) }}" method="POST" class="space-y-6">
                            @csrf

                            <!-- Parents Information Section -->
                            <div class="bg-gray-50 rounded-lg p-6">
                                <h4 class="text-lg font-semibold text-gray-800 mb-4">Parents Information</h4>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <!-- Father Information -->
                                    <div class="space-y-4">
                                        <h5 class="text-md font-medium text-gray-700 border-b pb-2">Father</h5>
                                        <div>
                                            <label for="father_name" class="block text-sm font-medium text-gray-700 mb-2">Full Name</label>
                                            <input type="text" id="father_name" name="father_name" required
                                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                                        </div>
                                        <div>
                                            <label for="father_phone" class="block text-sm font-medium text-gray-700 mb-2">Phone Number</label>
                                    ...
                                    <!-- Mother Information -->
                                    <div class="space-y-4">
                                        <h5 class="text-md font-medium text-gray-700 border-b pb-2">Mother</h5>
                                        <div>
                                            <label for="mother_name" class="block text-sm font-medium text-gray-700 mb-2">Full Name</label>
                                            <input type="text" id="mother_name" name="mother_name" required
                                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                                        </div>
                                        <div>
                                            <label for="mother_phone" class="block text-sm font-medium text-gray-700 mb-2">Phone Number</label>
                            ...
                            <div class="bg-green-50 rounded-lg p-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        <label for="birth_location" class="block text-sm font-medium text-gray-700 mb-2">Birth Location</label>
                            ...
                            <div class="bg-purple-50 rounded-lg p-6">
                                <h4 class="text-lg font-semibold text-gray-800 mb-4">Vaccine Details</h4>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        <label for="vaccine_category_id" class="block text-sm font-medium text-gray-700 mb-2">Vaccine Type</label>
                                        <select id="vaccine_category_id" name="vaccine_category_id" required
                                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-colors">
                                            <option value="">Select Vaccine Type</option>
                                            @foreach($categories as $category)
                                                <option value="{{ $category->_id }}">
                                                    {{ $category->name }} ({{ $category->dose }} doses)
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="mt-4 flex items-center">
                                    ...
                                    <label for="comeback" class="ml-3 text-sm font-medium text-gray-700">
                                        Schedule for follow-up/next dose
                                    </label>
                                </div>
                            </div>
