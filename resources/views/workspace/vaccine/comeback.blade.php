                    ...
                    <div class="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-lg">
                        ...
                        <div x-show="isModalOpen" x-transition.opacity.duration.300ms
                            ...
                            <div x-transition.scale.duration.300ms @click.away="closeModal()"
                                ...
                                <!-- New Header -->
                                <div
                                    class="flex items-center justify-between border-b border-gray-200 p-6 bg-gradient-to-r rounded-t-3xl">
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            <h3 class="text-2xl font-bold text-gray-800 mb-0" id="modal-title">
                                    ...
                                    <template
                                        ...
                                        <div class="mt-6">
                                            <div class="flex items-center mb-3">
                                                ...
                                                <h4 class="font-bold text-md text-green-600">
                                                    {{ trans('lang.dose dates') }}</h4>
                                            </div>

                                            <!-- Timeline Style List -->
                                            <ol class="relative border-l-2 border-green-200 ml-3"
                                                ...
                                                <template x-for="(doseDate, index) in modalData.dose_dates"
                                                    ...
                                                    <li class="mb-6 ml-6 relative">
                                                        <!-- Number Circle -->
                                                        <span
                                                            class="absolute -left-3 flex items-center justify-center w-6 h-6 bg-green-100 rounded-full border border-green-300 text-green-600 font-bold shadow">
                                                            <span x-text="index + 1"></span>
                                                        </span>

                                                        <!-- Date Display -->
                                                        <span
                                                            class="block mt-1 px-4 py-1 rounded-lg text-sm font-semibold bg-gradient-to-r from-green-100 to-green-200 text-green-700 shadow-sm"
                                ...
                                <div
                                    ...
                                    <button @click="closeModal()" type="button"
                                        class="inline-flex items-center rounded-lg border border-green-500 bg-green-500 px-6 py-3 text-sm font-semibold text-white shadow-sm hover:bg-green-600 focus:outline-none transition-all duration-200">
                            ...
                            <div x-transition.scale.duration.300ms @click.away="closeAddDoseModal()"
                                ...
                                <div class="flex items-center justify-between p-6 border-b border-gray-100">
                                    <div class="flex justify-between items-center">
                                        <div
                                            class="w-10 h-10 bg-blue-500 rounded-xl flex items-center justify-center mr-3 text-white">
                                            <div class="flex justify-between items-center">
                                                <div class="flex items-center space-x-3">
                                ...
                                <form method="POST" action="{{ route('workspace.vaccine.addDose') }}"
                                            ...
                                            <div class="relative">
                                                <label class="relative inline-flex items-center cursor-pointer">
                                                    <input type="checkbox" name="comeback" class="sr-only peer"
                                                        x-model="addDoseData.comeback" />
                                                    <div
                                                        class="relative w-14 h-7 bg-gray-200 peer-checked:bg-blue-500 rounded-full
                                                        ...
                                                        <span
                                                            class="pointer-events-none absolute left-2 top-1.5 text-[11px] font-bold text-white"
                                                            :class="addDoseData.comeback ? 'inline' : 'hidden'">ON</span>
                                                        <span
                                                            class="pointer-events-none absolute right-2 top-1.5 text-[11px] font-bold text-gray-600"
                                                            :class="!addDoseData.comeback ? 'inline' : 'hidden'">OFF</span>
                                                    </div>
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="flex justify-end space-x-4 pt-6 border-t border-gray-200">
                                        <button type="button" @click="closeAddDoseModal()"
                                            class="px-6 py-3 rounded-xl border border-gray-300 text-gray-700 font-semibold hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200">
                                            {{ trans('lang.cancel') }}
                                        </button>
                                        <button type="submit"
                                            class="px-8 py-3 bg-gradient-to-r bg-blue-500 to-red-600 hover:from-blue-600 hover:to-red-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 transform hover:-translate-y-0.5">
