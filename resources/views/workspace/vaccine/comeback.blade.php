                    ...
                    <div class="relative overflow-x-auto shadow-md sm:rounded-lg" x-data="vaccineModal()">
                        ...
                        <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-8 gap-6">
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    <h1 class="text-4xl font-bold text-gray-800 tracking-tight">Vaccine Comeback Records
                                    </h1>
                                    <p class="text-gray-600 mt-2 text-lg">Track and manage vaccine comeback schedules
                                    </p>
                                </div>
                            </div>
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-100">
                                        @forelse ($vaccinesComeback as $vaccine)
                                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                                ...
                                                <td class="px-8 py-4 flex flex-col space-y-2">
                                                    <button @click="openAddDoseModal(@js($vaccine))"
                                                        class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-orange-500 to-red-600 hover:from-orange-600 bg-blue-500 hover:to-red-700 text-white text-sm font-semibold rounded-lg transition-all duration-200 shadow-md hover:shadow-lg transform hover:-translate-y-0.5">
                                                    ...
                                                    <button @click="openModal(@js($vaccine))"
                                                        class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 bg-green-500 text-white text-sm font-semibold rounded-lg transition-all duration-200 shadow-md hover:shadow-lg transform hover:-translate-y-0.5">
                                            ...
                                            <tr>
                                                <td colspan="10" class="px-8 py-16 text-center">
                                                    <div class="flex flex-col items-center text-gray-500">
                                                        ...
                                                        <p class="text-xl font-medium text-gray-600">No comeback
                                                            records found</p>
                                                        <p class="text-gray-500 mt-2">No patients are currently
                                                            scheduled for vaccine comebacks</p>
                                                    </div>
                                                </td>
                                            </tr>
                                        @endforelse
                            ...
                            <div x-transition.scale.duration.300ms @click.away="closeModal()"
                                ...
                                <div class="px-8 py-6 max-h-[70vh] overflow-y-auto">
                                    <div class="space-y-10 text-gray-800">
                                        ...
                                        <div>
                                            <h4
                                                class="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-4 flex items-center">
                                            ...
                                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                                ...
                                                <div
                                                    ...
                                                    <p
                                                        ...
                                                        Date of Birth</p>
                                                    <p class="mt-2 text-lg font-bold text-gray-800"
                                                        x-text="formatDate(modalData.bod)"></p>
                                                </div>
                                                <div
                                                    class="p-4 bg-gray-50 rounded-xl shadow-sm border border-gray-200">
                                                    <p
                                                        ...
                                                        Age</p>
                                                    <span
                                                        class="inline-flex items-center mt-2 px-3 py-1 rounded-full text-xs font-semibold bg-gradient-to-r from-blue-100 to-blue-200 text-blue-800 shadow-sm"
                                                ...
                                                <div
                                                    ...
                                                    <p
                                                        ...
                                                        Father's Name</p>
                                                    <p class="mt-2 text-lg font-bold text-gray-800"
                                                        x-text="modalData.father_name"></p>
                                                </div>
                                                <div
                                                    class="p-4 bg-gray-50 rounded-xl shadow-sm border border-gray-200">
                                                    <p
                                                        ...
                                                        Mother's Name</p>
                                                    <p class="mt-2 text-lg font-bold text-gray-800"
                                                        x-text="modalData.mother_name"></p>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                                <div
                                                    ...
                                                    <p
                                                        ...
                                                        Vaccine Type</p>
                                                    <span
                                                        class="inline-flex items-center mt-2 px-3 py-1 rounded-full text-xs font-semibold bg-gradient-to-r from-green-100 to-green-200 text-green-800 shadow-sm"
                                                        x-text="modalData.vaccine_type ?? 'N/A'"></span>
                                                </div>
                                                <div
                                                    class="p-4 bg-gray-50 rounded-xl shadow-sm border border-gray-200">
                                                    <p
                                                        ...
                                                        Dose Count</p>
                                                    <span
                                                        class="inline-flex items-center mt-2 px-3 py-1 rounded-full text-xs font-semibold bg-gradient-to-r from-purple-100 to-purple-200 text-purple-800 shadow-sm"
                                                ...
                                                <div
                                                    ...
                                                    <p
                                                        ...
                                                        Date</p>
                                                    <p class="mt-2 text-lg font-bold text-gray-800"
                                                        x-text="formatDate(modalData.currentDate)"></p>
                                                </div>
                                                <div
                                                    class="p-4 bg-gray-50 rounded-xl shadow-sm border border-gray-200 sm:col-span-2">
                                                    <p
                                                        class="text-xs uppercase tracking-wide text-gray-500 font-semibold">
                                                        Description</p>
                                                    <div class="mt-2 p-4 rounded-lg bg-white text-gray-700 border border-gray-200 shadow-sm"
                                                        x-text="modalData.description"></div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <template
                                            ...
                                            <div>
                                                <h4
                                                    class="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-4 flex items-center">
                                                    <svg class="w-4 h-4 mr-2 text-amber-600" fill="none"
                                                        stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                            stroke-width="2" d="M12 8v4l3 3M5 3v4m0 0h4m-4 0l4-4" />
                                                    </svg>
                                                    Comeback Schedule
                                                </h4>
                                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                                    <template x-if="modalData.first_come">
                                                        <div
                                                            class="p-4 bg-gray-50 rounded-xl shadow-sm border border-gray-200">
                                                            <p
                                                                class="text-xs uppercase tracking-wide text-gray-500 font-semibold">
                                                                First Come</p>
                                                            <span
                                                                class="inline-flex items-center mt-2 px-3 py-1 rounded-full text-xs font-semibold bg-gradient-to-r from-amber-100 to-amber-200 text-amber-800 shadow-sm"
                                                                x-text="modalData.first_come"></span>
                                                        </div>
                                                    </template>
                                                    <template x-if="modalData.second_come">
                                                        <div
                                                            class="p-4 bg-gray-50 rounded-xl shadow-sm border border-gray-200">
                                                            <p
                                                                class="text-xs uppercase tracking-wide text-gray-500 font-semibold">
                                                            ...
                                                            <span
                                                                class="inline-flex items-center mt-2 px-3 py-1 rounded-full text-xs font-semibold bg-gradient-to-r from-amber-100 to-amber-200 text-amber-800 shadow-sm"
                                                                x-text="modalData.second_come"></span>
                                                        </div>
                                                    </template>
                                                    <template x-if="modalData.third_come">
                                                        <div
                                                            class="p-4 bg-gray-50 rounded-xl shadow-sm border border-gray-200">
                                                            <p
                                                                class="text-xs uppercase tracking-wide text-gray-500 font-semibold">
                                                            ...
                                                            <span
                                                                class="inline-flex items-center mt-2 px-3 py-1 rounded-full text-xs font-semibold bg-gradient-to-r from-amber-100 to-amber-200 text-amber-800 shadow-sm"
                                                                x-text="modalData.third_come"></span>
                                                        </div>
                                                    </template>
                                                    <template x-if="modalData.fourt_come">
                                                        <div
                                                            class="p-4 bg-gray-50 rounded-xl shadow-sm border border-gray-200">
                                                            <p
                                                                class="text-xs uppercase tracking-wide text-gray-500 font-semibold">
                                                            ...
                                                            <span
                                                                class="inline-flex items-center mt-2 px-3 py-1 rounded-full text-xs font-semibold bg-gradient-to-r from-amber-100 to-amber-200 text-amber-800 shadow-sm"
                                                                x-text="modalData.fourt_come"></span>
                                                        </div>
                                                    </template>
                                                    <template x-if="modalData.fifth_come">
                                                        <div
                                                            class="p-4 bg-gray-50 rounded-xl shadow-sm border border-gray-200">
                                                            <p
                                                                class="text-xs uppercase tracking-wide text-gray-500 font-semibold">
                                                            ...
                                                            <span
                                                                class="inline-flex items-center mt-2 px-3 py-1 rounded-full text-xs font-semibold bg-gradient-to-r from-amber-100 to-amber-200 text-amber-800 shadow-sm"
                                                                x-text="modalData.fifth_come"></span>
                                                        </div>
                                                    </template>
                                                </div>
                                            </div>
                                ...
                                <!-- Footer -->
                                <div class="flex justify-end border-t border-gray-200 px-8 py-6">
                                    <button @click="closeModal()" type="button"
                                        class="inline-flex justify-center rounded-lg border border-gray-300 bg-white px-6 py-3 text-sm font-semibold text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200">
                                        Close
                                    </button>
                                </div>
                            </div>
                            ...
                            <div x-transition.scale.duration.300ms @click.away="closeAddDoseModal()"
                                ...
                                <div class="flex items-center justify-between p-6 border-b border-gray-100">
                                    <div class="flex justify-between items-center">
                                        ...
                                        <div>
                                            <h3 class="text-2xl font-bold text-gray-900"> Add Dose</h3>
                                            <p class="text-sm text-gray-500">Patient: <span x-text="addDoseData.name"
                                ...
                                <form method="POST" action="{{ route('workspace.vaccine.addDose') }}"
                                    ...
                                    <div
                                        ...
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                            <div class="bg-white rounded-xl p-4 border border-gray-200">
                                                <label
                                                    class="block text-gray-600 text-sm font-medium mb-2">Name</label>
                                                <p class="text-gray-900 text-lg font-semibold"
                                                    x-text="addDoseData.name"></p>
                                            </div>
                                            <div class="bg-white rounded-xl p-4 border border-gray-200">
                                                <label class="block text-gray-600 text-sm font-medium mb-2">Age</label>
                                                <p class="text-gray-900 text-lg font-semibold"
                                                    x-text="addDoseData.age + ' years'"></p>
                                            </div>
                                            <div class="bg-white rounded-xl p-4 border border-gray-200">
                                                <label class="block text-gray-600 text-sm font-medium mb-2">Vaccine
                                                    Type</label>
                                                <p class="text-gray-900 text-lg font-semibold"
                                                    x-text="addDoseData.comeback_count ?? 'N/A'"></p>
                                            </div>
                                            <div class="bg-white rounded-xl p-4 border border-gray-200">
                                                <label class="block text-gray-600 text-sm font-medium mb-2">Current
                                                    Dose Count</label>
                                                <p class="text-gray-900 text-lg font-semibold"
                                                    x-text="addDoseData.comeback_count ?? 'N/A'"></p>
                                            </div>
                                    ...
                                    <div
                                        ...
                                        <div class="flex items-center justify-between">
                                            <div>
                                                <p class="text-gray-800 font-semibold text-lg">Mark for Comeback</p>
                                                <p class="text-gray-600 text-sm mt-1">Schedule this patient for a
                                                    follow-up vaccine dose</p>
                                            </div>
                                            <div class="relative">
                                                <label class="relative inline-flex items-center cursor-pointer">
                                                    <input type="checkbox" name="comeback" class="sr-only peer" />
                                                    <div
